...
impl ContractParametersContext {
    ...
    pub fn new(hash: String, data: String, items: Option<HashMap<String, ContextItem>>, network: u32) -> Self {
        Self {
...
impl ContextItem {
    ...
    pub fn new(script: String, parameters: Option<Vec<ContractParameter>>, signatures: Option<HashMap<String, String>>) -> Self {
        Self {
            script,
            parameters,
