...
impl PolicyContract {
    ...
    pub fn block_account_address(&self, address: &str) -> Result<TransactionBuilder, ContractError> {
    ...
    pub fn unblock_account_address(&self, address: &str) -> Result<TransactionBuilder, ContractError> {
        let account = H160::from_address(address)?;
