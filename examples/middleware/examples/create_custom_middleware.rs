...
/// This example demonstrates the mechanisms for creating custom middlewares in neo-rs.
...
/// neo-rs providers by creating and using custom middlewares.
///
/// This custom middleware increases the gas value of transactions sent through a neo-rs
...
async fn main() -> eyre::Result<()> {
	...
	let signer = wallet.with_network_magic(anvil.network_magic());
