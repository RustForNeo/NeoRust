...
async fn main() -> Result<()> {
	...
	let signer =
		Arc::new(SignerMiddleware::new(provider, from_wallet.with_network_magic(anvil.network_magic())));
...
async fn deploy_token_contract(
	...
	let provider =
		Provider::<Http>::try_from(anvil.endpoint())?.interval(Duration::from_millis(10u64));
	let client =
		SignerMiddleware::new(provider, deployer_wallet.with_network_magic(anvil.network_magic()));
