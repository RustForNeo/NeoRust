...
abigen!(Greeter, "neo-contract/tests/solidity-contracts/greeter.json",);
...
async fn main() -> Result<()> {
	...
	// Get the runtime bytecode for the Greeter contract using neo_call to
