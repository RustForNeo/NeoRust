...
use crate::{
	wallet::{mnemonic::MnemonicBuilderError, wallet::Wallet},
	WalletError,
};
...
use p256::ecdsa::signature::rand_core::CryptoRng;
...
// 		self.default_account.signer.to_raw_bytes().to_vec().eq(&other.signer.to_raw_bytes().to_vec())
