//! [Neo Name Service](https://docs.nns.domains/) support
//! Adapted from <https://github.com/hhatto/rust-nns/blob/master/src/lib.rs>

use neo_types::address::Address;
use primitive_types::H160;
use std::convert::TryInto;

/// NNS registry address (`0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e`)
...
/// Returns the NNS namehash as specified in [EIP-137](https://eips.neo.org/EIPS/eip-137)
...
/// Returns the NNS record key hash [EIP-634](https://eips.neo.org/EIPS/eip-634)
