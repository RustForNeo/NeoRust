...
// 	fn verify<M>(&self, message: M, public_key: &Secp256r1PublicKey) -> Result<(), SignatureError>
// 	where
// 		M: AsRef<[u8]>,
// 	{
// 		let mut msg = [0u8; 32];
...
// 	}
//
// 	/// Concatenates the fields of the Signature into a single byte array.
// 	pub fn to_raw_bytes(&self) -> Vec<u8> {
// 		let mut result = Vec::new();
//
// 		// Assuming U256 has a method to convert to a big-endian byte array.
// 		let mut r_bytes = vec![0u8; 32]; // U256 is 256 bits, hence 32 bytes.
...
//
// 		// Convert `v` (u64) to a byte array and append.
// 		result.extend(&self.v.to_be_bytes()); // Big-endian byte representation
//
// 		result
// 	}
// }
