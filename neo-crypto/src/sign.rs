...
impl Sign2 {
	...
	pub fn sign_hex_message(
		message: &str,
		secret_key: &Secp256r1PrivateKey,
	...
	pub fn sign_message(
		...
		secret_key.sign_tx(&hash).map_err(|_| CryptoError::SigningError)
	}
...
impl SignatureData {
	...
	/// Get the to_raw_bytes r and s values.
