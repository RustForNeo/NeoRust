...
pub enum GasOracleError {
	...
	/// An internal error in the EndPoint client request made from the underlying
	/// gas oracle
	#[error(transparent)]
	EndPointError(#[from] neo_neocan::errors::EndPointError),
	...
	ConversionError(#[from] utils::ConversionError),
}

/// A neo gas price oracle.
///
/// # Example
///
/// ```no_run
///
/// use neo_middleware::gas_oracle::{GasCategory, GasNow, GasOracle};
///
