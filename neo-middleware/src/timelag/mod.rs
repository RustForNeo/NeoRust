	...
	M: Middleware,
{
	...
	) -> Result<neo_providers::PendingTransaction<'_, Self::Provider>, Self::Error> {
		self.inner()
	...
	async fn new_filter(
		&self,
		_filter: neo_providers::FilterKind<'_>,
	) -> Result<U256, Self::Error> {
	...
	async fn watch_blocks(
		&self,
	) -> Result<neo_providers::FilterWatcher<'_, Self::Provider, TxHash>, Self::Error> {
		Err(TimeLagError::Unsupported)
	}
	...
	async fn subscribe<T, R>(
		&self,
		_params: T,
	) -> Result<neo_providers::SubscriptionStream<'_, Self::Provider, R>, Self::Error>
	where
	...
	async fn subscribe_pending_txs(
		&self,
	) -> Result<neo_providers::SubscriptionStream<'_, Self::Provider, TxHash>, Self::Error>
	where
		Self::Provider: neo_providers::PubsubClient,
	{
		Err(TimeLagError::Unsupported)
	...
	async fn subscribe_full_pending_txs(
		&self,
	) -> Result<neo_providers::SubscriptionStream<'_, Self::Provider, Transaction>, Self::Error>
	where
		Self::Provider: neo_providers::PubsubClient,
	{
		Err(TimeLagError::Unsupported)
